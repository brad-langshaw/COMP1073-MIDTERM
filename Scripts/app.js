...
console.log("App Started...")
	...
	function replaceParagraphs() {
		console.log("inside replaceparagraphs function");
		var IntroParagraph;
		var Folegandros;
		var Alonissos;
		var Spetses;
...
replaceParagraphs();
// contact me function to send user input to the console 
function ContactMetoConsole() {
		var firstName;
		var lastName;
		var email;
		var comments;
		...
		console.log(firstName.val, lastName.val, email.val, comments.val);
